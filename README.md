...
- Durable SQLite state, a single supervisor lock per target repository, isolated Git worktrees, checks, section commits, crash reconciliation after a commit, and bounded repair attempts.
